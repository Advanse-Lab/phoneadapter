...
INSERT INTO PROFILE(profile_name,ring_volume,airplane_mode, vibration) VALUES ('Escritorio',0,0,0);
INSERT INTO PROFILE(profile_name,ring_volume,airplane_mode, vibration) VALUES ('Reuniao',0,0,0);
...
INSERT INTO RULE(rule_name,current_state_id,new_state_id, priority,action_id,enabled) VALUES ('AtivarDirigindo_Geral',1,5,2,5,1);
INSERT INTO RULE(rule_name,current_state_id,new_state_id, priority,action_id,enabled) VALUES ('AtivarDirigindo_Casa',4,5,2,5,1);
INSERT INTO RULE(rule_name,current_state_id,new_state_id, priority,action_id,enabled) VALUES ('AtivarDirigindo_Escritorio',7,5,2,5,1);
INSERT INTO RULE(rule_name,current_state_id,new_state_id, priority,action_id,enabled) VALUES ('AtivarDirigindo_NaRua',2,5,2,5,1);
INSERT INTO RULE(rule_name,current_state_id,new_state_id, priority,action_id,enabled) VALUES ('DesativarDirigindo',5,1,2,1,1);
INSERT INTO RULE(rule_name,current_state_id,new_state_id, priority,action_id,enabled) VALUES ('AtivarDirigindoRapido',5,6,1,6,1);
INSERT INTO RULE(rule_name,current_state_id,new_state_id, priority,action_id,enabled) VALUES ('DesativarDirigindoRapido_GPSNaoValido',6,5,1,5,1);
INSERT INTO RULE(rule_name,current_state_id,new_state_id, priority,action_id,enabled) VALUES ('DesativarDirigindoRapido_VelocidadeMenorIgual70',6,5,1,5,1);
...
INSERT INTO RULE(rule_name,current_state_id,new_state_id, priority,action_id,enabled) VALUES ('AtivarCasa_GPS',1,4,5,4,1);
...
INSERT INTO RULE(rule_name,current_state_id,new_state_id, priority,action_id,enabled) VALUES ('AtivarEscritorio_GPS',1,7,5,7,1);
...
INSERT INTO FILTER(cv_type,cv_operator,value,rule_row_id) VALUES (2,2,'-21.979769,-47.880300',1);
...
INSERT INTO FILTER(cv_type,cv_operator,value,rule_row_id) VALUES (2,1,'-21.979769,-47.880300',4);
INSERT INTO FILTER(cv_type,cv_operator,value,rule_row_id) VALUES (1,1,'true',5);
...
INSERT INTO FILTER(cv_type,cv_operator,value,rule_row_id) VALUES (2,2,'-20.999935,-48.210638',0);
INSERT INTO FILTER(cv_type,cv_operator,value,rule_row_id) VALUES (2,2,'-20.999935,-48.210638',19);
INSERT INTO FILTER(cv_type,cv_operator,value,rule_row_id) VALUES (4,1,'DC:53:60:4F:02:AA',20);
INSERT INTO FILTER(cv_type,cv_operator,value,rule_row_id) VALUES (1,1,'true',21);
INSERT INTO FILTER(cv_type,cv_operator,value,rule_row_id) VALUES (2,1,'-21.979769,-47.880300',21);
INSERT INTO FILTER(cv_type,cv_operator,value,rule_row_id) VALUES (4,2,'DC:53:60:4F:02:AA',22);
INSERT INTO FILTER(cv_type,cv_operator,value,rule_row_id) VALUES (1,1,'true',23);
INSERT INTO FILTER(cv_type,cv_operator,value,rule_row_id) VALUES (2,2,'-21.979769,-47.880300',23);
INSERT INTO FILTER(cv_type,cv_operator,value,rule_row_id) VALUES (6,4,'14:00:00',24);
INSERT INTO FILTER(cv_type,cv_operator,value,rule_row_id) VALUES (5,4,3,24);
INSERT INTO FILTER(cv_type,cv_operator,value,rule_row_id) VALUES (6,4,'16:00:00',25);
INSERT INTO FILTER(cv_type,cv_operator,value,rule_row_id) VALUES (4,1,'1C:39:47:0D:4A:BC',26);
INSERT INTO FILTER(cv_type,cv_operator,value,rule_row_id) VALUES (4,1,'DC:53:60:4F:02:AA',27);
INSERT INTO FILTER(cv_type,cv_operator,value,rule_row_id) VALUES (4,2,'1C:39:47:0D:4A:BC',28);
INSERT INTO FILTER(cv_type,cv_operator,value,rule_row_id) VALUES (4,2,'DC:53:60:4F:02:AA',28);
